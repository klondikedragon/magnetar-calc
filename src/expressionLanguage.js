...
export const expressionImplementations = [
  ...
  ["sequence-immortal-kangaroo", { calls: ["kangaroo"], kind: "sequence" }],
  ["sequence-recaman", { calls: ["recaman"], kind: "sequence" }],
  ["sequence-stern", { calls: ["stern"], kind: "sequence" }],
  ...
  ["scientific-floor", { calls: ["floor"], kind: "unary" }],
  ["scientific-ceil", { calls: ["ceil"], kind: "unary" }],
  ["scientific-trunc", { calls: ["trunc"], kind: "unary" }],
  ["scientific-round", { calls: ["round"], kind: "round" }],
  ["scientific-round-significant", { calls: ["roundSig"], kind: "round" }],
  ["scientific-round-to", { calls: ["roundTo"], kind: "round" }],
  ["scientific-cube-root", { calls: ["cbrt"], kind: "unary" }],
  ["logarithm-base-two", { calls: ["log2"], kind: "unary" }],
  ["trigonometry-asin", { calls: ["asin"], kind: "unary" }],
  ["trigonometry-acos", { calls: ["acos"], kind: "unary" }],
  ["trigonometry-atan", { calls: ["atan"], kind: "unary" }],
  ["trigonometry-atan2", { calls: ["atan2"], kind: "binary-call" }],
  ["trigonometry-sinh", { calls: ["sinh"], kind: "unary" }],
  ["trigonometry-cosh", { calls: ["cosh"], kind: "unary" }],
  ["trigonometry-tanh", { calls: ["tanh"], kind: "unary" }],
  ["trigonometry-asinh", { calls: ["asinh"], kind: "unary" }],
  ["trigonometry-acosh", { calls: ["acosh"], kind: "unary" }],
  ["trigonometry-atanh", { calls: ["atanh"], kind: "unary" }],
  ["trigonometry-radians", { calls: ["rad"], kind: "unary" }],
  ["trigonometry-degrees", { calls: ["deg"], kind: "unary" }],
];
