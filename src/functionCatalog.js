...
const catalogEntries = [
  ...
  { id: "sequence-immortal-kangaroo", signature: "kangaroo(n)", name: "Immortal kangaroo sequence", category: "Sequences", description: "The nth term of the lexicographically earliest infinite comma-child path beginning at 20. This engine computes the source-published, uniquely determined prefix n ≤ 20,000.", keywords: ["immortal kangaroo", "kangaroo", "comma sequence", "comma child", "numberphile", "neil sloane", "oeis", "a367620", "konig infinity lemma"], links: [{ provider: "oeis", label: "OEIS A367620: Immortal kangaroo path", url: "https://oeis.org/A367620" }, { provider: "youtube", label: "The Immortal Kangaroo Sequence — Numberphile", url: "https://www.youtube.com/watch?v=A020pGO5MBs" }, { provider: "paper", label: "The Comma Sequence: A Simple Sequence With Bizarre Properties", url: "https://arxiv.org/abs/2401.14346" }], insertion: { empty: "kangaroo($cursor)", selected: "kangaroo($selection$cursor)" } },
  { id: "sequence-recaman", signature: "recaman(n)", name: "Recamán's sequence", category: "Sequences", description: "The nth term of the standard subtract-if-possible sequence. It prefers a new positive backward move, otherwise moves forward. In-memory generation supports n ≤ 100,000.", keywords: ["recaman", "numberphile", "greedy", "walk", "oeis", "a005132", "sequence", "graph"], links: [{ provider: "oeis", label: "OEIS A005132: Recamán's sequence", url: "https://oeis.org/A005132" }, { provider: "youtube", label: "The Slightly Spooky Recamán Sequence — Numberphile", url: "https://www.youtube.com/watch?v=FGC5TdIiT9U" }], insertion: { empty: "recaman($cursor)", selected: "recaman($selection$cursor)" } },
  { id: "sequence-stern", signature: "stern(n)", name: "Stern's diatomic sequence", category: "Sequences", description: "The nth Stern diatomic value, computed from a binary recurrence. Consecutive ratios enumerate reduced nonnegative rationals.", keywords: ["stern", "diatomic", "stern-brocot", "calkin-wilf", "numberphile", "oeis", "a002487", "binary", "fractions"], links: [{ provider: "oeis", label: "OEIS A002487: Stern's diatomic sequence", url: "https://oeis.org/A002487" }, { provider: "youtube", label: "Amazing Graphs III — Numberphile", url: "https://www.youtube.com/watch?v=j0o-pMIR8uk" }], insertion: { empty: "stern($cursor)", selected: "stern($selection$cursor)" } },
